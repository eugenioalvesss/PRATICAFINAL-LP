...
public class Home extends JFrame {
	...
	public Home() {
		...
		try{
			...
			hora = new javax.swing.JFormattedTextField(hour);
			}
			catch (Exception e){
			}
		hora.setBounds(23, 75, 37, 20);
	//	hora.setBounds(23, 75, 46, 20);
		...
		buttonSalvar.addActionListener(new ActionListener() {
			...
			/*	data.setText("");
				hora.setText("");
				descricao.setText("");
				emExecucao.setSelected(false);
				paralisado.setSelected(false);
				executado.setSelected(false);*/
